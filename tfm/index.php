...
/**
 * Subscription Manager V0.1
 * @author Intrinsically-Sublime
 * @github https://github.com/Intrinsically-Sublime
 *
 * ******* Based on *******
...
//Hide settings menu. Hide when mounting the index.php file as read only.
$HIDE_SETTINGS = true;

//Hide bulk action buttons since we are not dealing with a lot of files
$HIDE_BULK_BUTTONS = true;
...
// Text viewer highlight.js style , use 'ir-black' or 'vs'
// Text viewer follows system theme
if((new FM_Config())->data['theme'] == "dark") {
    $highlightjs_style = 'ir-black';
} else {
    $highlightjs_style = 'vs';
}

// ACE Advanced Code Editor default theme
// example: Light = sqlserver, Dark = tomorrow_night 
define('ACE_THEME', 'tomorrow_night');

// Enable ace.js (https://ace.c9.io/) on view's page (Advanced Code Editor)
$edit_files = true;

// Default timezone for date() and time()
// Doc - http://php.net/manual/en/timezones.php
$default_timezone = 'America/Vancouver'; // UTC
...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'yml,txt,env,ls,css,yaml,json';

// Allowed file extensions for upload files
// e.g. 'gif,png,jpg,html,txt'
$allowed_upload_extensions = 'yml,txt,env,ls,css,yaml,json';

// Favicon path. This can be either a full url to a .PNG image, or a path based on the document root.
// full path, e.g http://example.com/favicon.png
// local path, e.g images/icons/favicon.png
$favicon_path = 'data/images/favicon.png';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', ...)
$exclude_items = array('images');
...
$max_upload_size_bytes = 1000000; // size 1,000,000bytes (~1MB)
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       <div class="brand">
                                            <img src="data/images/youtube-downloader.svg" M1008 width="100%" viewBox="0 0 238.000000 140.000000" aria-label="Subscription Manager">
                                               </img>
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="<?php echo SITE; ?>" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>"><?php echo AUTHOR; ?></a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
// Run ytdl-sub
if (isset($_POST['group'], $_POST['run'], $_POST['token']) && !FM_READONLY) {
...
// Dry-un ytdl-sub
if (isset($_POST['group'], $_POST['dry-run'], $_POST['token']) && !FM_READONLY) {
...
if (isset($_POST['subscribe']) && !FM_READONLY) {

$formTheme = (FM_THEME == "dark") ? "text-white bg-dark table-dark" : "bg-white";
    
    fm_show_header(); // HEADER
    fm_show_nav_path(""); // current path
    ?>
    <div class="path">
        <div class="card <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <h6><?php echo lng('Add Subscription') ?></h6>
            </div>
            <div class="card-body">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <label for="sel1">Subscription Name:</label>
                                    <input type="text" class="form-control <?php echo $formTheme; ?>" id="sel1" placeholder="Name for your new subscription.">
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <label for="sel2">Metadata Consumer:</label>
                                    <select class="form-control <?php echo $formTheme; ?>" id="sel2">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <label for="sel3">Media Type:</label>
                                    <select class="form-control <?php echo $formTheme; ?>" id="sel3">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <label for="sel4">Preset:</label>
                                    <select class="form-control <?php echo $formTheme; ?>" id="sel4">
                                        <optgroup label="Video">
                                            <option>episode</option>
                                            <option>tv_show</option>
                                            <option>tv_show_by_date</option>
                                            <option>tv_show_collection</option>
                                        </optgroup>
                                        <optgroup label="Music">
                                            <option>singles</option>
                                            <option>albums_from_playlists</option>
                                            <option>albums_from_chapters</option>
                                            <option>other_websites</option>
                                        </optgroup>
                                        <optgroup label="Music Videos">
                                            <option>music_videos</option>
                                            <option>music_video_base</option>
                                        </optgroup>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12 col-md-6">
                                    <label for="sel5"> Previous Overrides:</label>
                                    <select multiple class="form-control <?php echo $formTheme; ?>" id="sel5">
                                        <option>ToDo:</option>
                                        <option>Automatically populate overrides </option>
                                        <option>and presets by parsing previous </option>
                                        <option>subscriptions and examples.</option>
                                    </select>
                                </div>
                                <div class="col-xs-12 col-md-6">
                                    <label for="sel6">Advanced:</label>
                                    <textarea class="form-control <?php echo $formTheme; ?>" rows="3" id="sel6" placeholder="Enter properly formatted overrides to be added to the overrides section."></textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-12">
                                <label for="sel7">Subscription URL to add:</label>
                                <input type="text" class="form-control <?php echo $formTheme; ?>" id="sel7" placeholder="Enter the URL of the channel, playlist, video or track.">
                            </div>
                            <div class="col-xs-12 col-md-12">
                                <p class="break-word"><strong> </strong></p>
                                    <b><a href="?p=<?php echo urlencode(FM_PATH) ?>" class="btn btn-outline-danger"><i class="fa fa-times-circle"></i> <?php echo lng('Cancel') ?></a></b>&nbsp;
                                    <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                                    <button type="submit" class="btn btn-success"><i class="fa fa-check-circle"></i> <?php echo lng('Add') ?></button> 
                                </p>
                            </div>
                        </form>
                  </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="<?php echo SITE; ?>" target="_blank" class="app-v-title"> <?php echo APP_TITLE; ?> <?php echo VERSION; ?></a></h3></p>
                        <p>Author: <?php echo AUTHOR; ?></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://tinyfilemanager.github.io/" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Based on Tiny File Manager') ?> </a> </li>
                                <li class="list-group-item"><a href="https://github.com/prasathmani/tinyfilemanager/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('TFM Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="<?php echo BUG_SITE; ?>" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
                                <?php if(!FM_READONLY) { ?>
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                            ...
                            <a title="<?php echo lng('Copy/Move')?>" href="?p=&amp;copy=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="fa fa-files-o" aria-hidden="true"></i></a>
                        <?php endif; ?>
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        <?php if (!FM_READONLY): ?>
                            ...
                            <a title="<?php echo lng('Copy/Move') ?>" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;copy=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="fa fa-files-o"></i></a>
                        <?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                ...
                <?php endif; ?>                    
                <li class="list-inline-item"><input type="submit" class="hidden" name="subscribe" id="a-subscribe" value="subscribe">
                    <a href="javascript:document.getElementById('a-subscribe').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-plus-square-o"></i> <?php echo lng('Add Subscription') ?> </a></li>
                ...
                <li class="list-inline-item"><input type="submit" class="hidden" name="copy" id="a-copy" value="copy">
                    <a href="javascript:document.getElementById('a-copy').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-files-o"></i> <?php echo lng('Copy/Move') ?> </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="run-ytdl-sub" id="a-run" value="run-ytdl-sub" onclick="return confirm('<?php echo nl2br (lng('Process all subscriptions? \n\n*****-----Not implemented yet!-----*****')); ?>')">
                    <a href="javascript:document.getElementById('a-run').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-download"></i> <?php echo lng('Run') ?> </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="dry-run-ytdl-sub" id="a-dry-run" value="dry-run-ytdl-sub" onclick="return confirm('<?php echo nl2br (lng('Dry-run processing all subscriptions? \n\n*****-----Not implemented yet!-----*****')); ?>')">
                    <a href="javascript:document.getElementById('a-run').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-check-square-o"></i> <?php echo lng('Dry-run') ?> </a></li>
            </ul>
        </div>
        <div class="col-3 d-none d-sm-block"><a href="<?php echo SITE; ?>" target="_blank" class="float-right text-muted"><?php echo APP_TITLE; ?> <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="<?php echo SITE; ?>" target="_blank" class="float-right text-muted"><?php echo APP_TITLE; ?> <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
{
    global $lang, $sticky_navbar, $editFile, $HIDE_SETTINGS;
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = "<a href='?p='><i aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
            ...
            if ($path != '') {
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    $array[] = "<a style=font-size:18px; href='?p={$parent_enc}'>" . fm_enc(fm_convert_win($exploded[$i])) . "</a>";
                }
                $root_url .= $sep . implode($sep, $array);
            }
            echo '<div class="col-xs-5 col-sm-4">' . $root_url . $editFile . '</div>';
            ?>
                ...
                <ul class="navbar-nav justify-content-end <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu text-small shadow <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            <?php if (!FM_READONLY && !$HIDE_SETTINGS): ?>
...
<head>
    ...
    <meta name="description" content="Web based ytdl-sub Manager in PHP, Manage your subscriptions efficiently and easily.">
    ...
    <style>
        ...
        .fm-login-page .brand{ width:121px;overflow:hidden;margin:10px auto;position:relative;z-index:1}
...
<head>
    ...
    <style>
        ...
        *,*::before,*::after { box-sizing: border-box;}
        ...
        .navbar-brand { font-weight:bold;font-size:15px;border-radius:20px;background:#a80d0d;padding-left:15px;padding-right:15px;border:1px;border-style:solid; }
        ...
        /* Text editor follows system theme */
        <?php if (FM_THEME == "dark"): ?> 
            #normal-editor { border-radius:3px;border-width:2px;padding:10px;outline:none;background-color:#333;color:#fff; }
        <?php else: ?>
        ...
        @media only screen and (min-device-width:768px) and (max-device-width:1024px) and (orientation:landscape) and (-webkit-min-device-pixel-ratio:2) { .navbar-collapse .col-xs-5 { padding:0; }
        }
...
<?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE && !FM_READONLY):
    ...
    <script>
        ...
        editor.setFontSize(16); //Set default font size
        editor.setTheme( "ace/theme/<?php echo ACE_THEME; ?>"); //Set ace theme
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Subcription Manager';    $tr['en']['AppTitle']           = 'Subcription Manager';
